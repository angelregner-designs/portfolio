interface BoxSectionProps {
  ...
  box2Title: string
  box2Content: string
  onChange: (field: 'box1Title' | 'box1Content' | 'box2Title' | 'box2Content', value: string) => void
}

const BoxSection = ({ box1Title, box1Content, box2Title, box2Content, onChange }: BoxSectionProps) => (
